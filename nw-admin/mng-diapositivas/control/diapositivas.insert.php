<?php
	...
	$hecho = array('success'=>true,'tit'=>'Exito!','msg'=>'Diapositiva agregada correctamente.','tipo'=>'success');
	$error = array('success'=>false,'tit'=>'Error!','msg'=>'Ocurrió un error, inténtelo más tarde.','tipo'=>'error');
	$directorio = '../../../img/diapositivas/';

	$insert['diap_imagen'] = 'iniciar';
	if (!$diapos->insert($insert)){
		echo json_encode($error);
		die();
	} else { $ID = $diapos->DB->GetLastInsertID(); }
